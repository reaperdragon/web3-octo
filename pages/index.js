  ...
  return (
    <div>
      ...
      <div className="h-screen flex items-center  font-body justify-center text-center">
        <div>
          <h2 className="text-[80px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-blue-800 my-2 leading-[120px]">
            The Web 3 Publishing Hub{" "}
          </h2>
          <p className="semibold text-gray-500 my-[26px] font-medium text-3xl">
            Built with Next Js, Arweave, Hardhat,Polygon Mumbai and All the CSS
            Magic with Tailwind CSS
          </p>
          <button
